            ...
            <div className='max-w-[720px] mx-auto flex justify-center flex-wrap mb-[50px]'>
                {
                    userNotifications?.length > 0 ? userNotifications.map((notification: Notification) => (
                        ...
                        >
                            ...
                            <p className="absolute top-[5px] right-[10px] text-[.9rem] ">{formatDate(notification.createdAt)}</p>
                            ...
                            <p className='italic text-[.9rem] text-[var(--gray-500)] mb-3'>{notification.blog.title}</p>
                            <p className="text-[.9rem] text-[var(--gray-500)] mt-1 mb-[-10px]">(Click to view)</p>
                        </Link>
                    ))
                        :
