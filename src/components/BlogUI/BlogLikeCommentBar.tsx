...
export default function BlogLikeCommentBar({ likes, blogId, commentCount, blogUrl, blogDescription, blogTitle, blogCoverPhotoUrl }: Props) {
    ...
    return (
        <section className="flex items-center mx-auto mb-[40px] justify-between py-[5px] max-w-[700px] my-5 px-4 text-[var(--gray-500)] border-t border-b border-[var(--gray-500)]">
