    ...
    return (
        <section className="relative h-[100vh] p-[20px] sm:p-0 bg-[url('/images/homepageHeader.png')] bg-cover flex items-center">
            <div className="sm:ps-[60px] mb-[200px] sm:mb-[200px]">
                ...
                <h2 className={`text-[1.1rem] opacity-[0.9] w-[90%] sm:w-[70%] mt-3 text-[var(--brown-600)] tracking-wider`}>Short arguments with myself. Leave with more questions than answers.</h2>
                <JumboCallToAction />
            </div>
        </section>
    )
