        ...
        <>
            {showModal === urlParam &&
                <div
                    ...
                    <div onClick={(e) => e.stopPropagation()} className="relative border border-[var(--gray-300)] bg-[var(--paper-color)] p-[10px_25px_25px] rounded-md w-[92%] xs:w-fit mb-[100px] animate-dropDown max-w-[430px]">
                        {title !== 'none' &&
