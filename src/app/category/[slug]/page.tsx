...
export default function Page({ params }: { params: { slug: string } }) {
    ...
    return (
        <main className="text-[var(--brown-600)] text-[19px] min-h-[100vh] sm:m-[2%] md:m-[5%] rounded-md">
            <h1 className="max-w-[700px] mx-auto text-5xl leading-[3.5rem] mb-[18px] font-[700]">How do I manage my time? Focus on career or family?</h1>
            ...
            {/* This is the Image */}
            <Image
                src={'/images/categories/family.png'}
                width={700}
                height={394}
                alt="Image of thing, should replace with data"
                className="block mx-auto mb-[45px]"
            />
            {/* This is the blog text */}
            <div className="max-w-[700px] mx-auto leading-9">
                <p>
