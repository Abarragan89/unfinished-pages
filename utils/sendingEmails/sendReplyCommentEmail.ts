...
export async function sendReplyCommentEmail(
    userArr: UserData[],
    blogLink: string,
    commentText: string,
    replierName: string,
    ...
    const emailPromises = userArr.map((user) => {
        ...
        const message: MailDataRequired = {
            ...
            subject: `${user.isParentCommentOwner ?
            ...
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;">
                ...
                ${user.isAuthor ?
                    ...
                    :
                    user.isParentCommentOwner ?
                        `<p style="color: #555;">${replierName} replied with:</p>`
                        :
                        '<p style="color: #555;">Others have joined the conversation on the blog you replied to!</p>'
                } 
